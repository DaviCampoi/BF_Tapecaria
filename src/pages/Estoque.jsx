...
if (filtroStatus === "todos") setFiltroStatus("tem")
else if (filtroStatus === "tem") setFiltroStatus("nao")
else setFiltroStatus("todos")
}
...
<input type="radio" checked={tem === true} onChange={()=>setTem(true)} /> Tem
</label>

<label>
<input type="radio" checked={tem === false} onChange={()=>setTem(false)} /> Não tem
</label>
