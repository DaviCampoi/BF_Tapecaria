  ...
  <div className="row g-0">
    ...
    <div className="col-md-6 sobre-texto">
      <div className="conteudo">
        ...
        <p>
          No jogo da personalização automotiva, a experiência é o nível mais alto. Com fundação em 1989, a BF Tapeçaria atravessou décadas evoluindo a estética de veículos clássicos e modernos. Somos especialistas em reformas completas e personalizações exclusivas que elevam seu carro ao próximo patamar. Tradição não se compra, se constrói..  
